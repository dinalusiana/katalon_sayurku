...
WebUI.setText(findTestObject('Page_Sayur - Sayurku.com/inputSearchText'), 'bayam')

WebUI.click(findTestObject('Page_Sayur - Sayurku.com/searchButton'))

WebUI.click(findTestObject('Page_Hasil Pencarian - Sayurku.com/textHargaRp. 3.000'))

WebUI.click(findTestObject('Page_Hasil Pencarian - Sayurku.com/bayamAkarProduk'))
